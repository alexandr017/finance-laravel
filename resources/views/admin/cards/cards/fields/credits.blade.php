  ...
  <div class="panel panel-info">
    ...
    <div id="collapse4" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading4">
        <div class="panel-body">
            ...
            <div class="form-group">
                <label for="desired_income_min">Доход заемщика:</label>
                <input class="form-control" type="number" value="{desired_income_min}" name="desired_income_min" id="desired_income_min">
            </div>
            <div class="form-group">
                <label for="providing_conditions">Условия обеспечения:</label>
                <textarea class="form-control" name="providing_conditions" id="providing_conditions" rows="8">{providing_conditions}</textarea>
            </div>
        </div>
    </div>
  </div>
