    ...
    <table id="rowtbl" class="table table-striped table-bordered table-hover">
        ...
        @foreach ($items as $item)
            <tr>
                ...
                <td>
                    <a href="/admin/banks/categories/{{$item->id}}"  class="btn btn-primary btn-xs" title="Редактировать"><i class="fa fa-edit"></i></a>
                    <a href="/admin/banks/categories/{{$item->id}}/delete" class="btn btn-danger btn-xs" title="Удалить"><i class="fa fa-trash"></i></a>
                </td>
            </tr>
        @endforeach
        </tbody>
