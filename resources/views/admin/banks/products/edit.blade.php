...
@section('content')
    ...
    @else
        <a target="_blank" href="/banki/{{ $bankAlias }}/{{$categoryAlias}}/{{ $productAlias }}/otzyvy" class="btn btn-info btn-xs"><i class="fa fa-eye"></i> Просмотреть страницу отзывов продукта банка</a>
