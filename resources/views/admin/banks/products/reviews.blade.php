...
@section ('title', 'Редактирование страницы отзывов продукта для банка')
@section ('h1', 'Редактирование страницы отзывов продукта для банка')

@section('content')

<form action="{{ route('admin.banks.products.reviews.update',[$bankID,$parentPageID,$categoryID]) }}" method="post">
