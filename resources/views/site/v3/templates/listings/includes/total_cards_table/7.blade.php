...
<table class="total_cards_table">
    ...
    <tr>
        ...
        <th>@if(isset($tag_name)) @if($tag_name!='')Займы {{mb_strtolower($tag_name)}} @else Название @endif @endif</th>
    ...
    <tr>
        ...
        <td>
            ...
            <a class="offer" href="{{$link}}" target="_blank">{{$card->title}}</a>
        </td>
        ...
        <td class="text-center">{{$card->header_2}} дней</td>
