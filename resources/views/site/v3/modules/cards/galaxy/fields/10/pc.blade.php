    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="lvc fa-percent">
                Процентная ставка:
                <div class="value">от {{number_format($card->percent_min, 0, '.', ' ')}} @if(isset($card->percent_max)) @if($card->percent_max != null) до {{number_format($card->percent_max, 0, '.', ' ')}} @endif @endif % в год</div>
            </div>
            @endif @endif
