...
*/ ?>
@if(!is_amp_page())
<span class="rko-card-btn active" data-tab="1">Общая<br> информация</span>
<span class="rko-card-btn line-height-30" data-tab="2">Эквайринг</span>
<span class="rko-card-btn" data-tab="3">Зарплатный <br>проект</span>
<span class="rko-card-btn" data-tab="4">Валютный <br>контроль</span>
<span class="rko-card-btn" data-tab="5">Корпоративные <br>карты</span>
<span class="rko-card-btn line-height-30" data-tab="6">Гарантии</span>
@endif
...
<div class="rko-card-wrap rko-card-wrap-4" data-tab="4">
    ...
    @if(isset($card->exchange_control_passport)) @if(($card->exchange_control_passport!==null))
        <div class="lvc fa-credit-card-alt">Постановка контракта на учет: <div class="value">{{$card->exchange_control_passport}}</div></div>
    @endif @endif
...
<div class="rko-card-wrap rko-card-wrap-5" data-tab="5">
...
<div class="rko-card-wrap rko-card-wrap-6" data-tab="6">
    <div class="row">
        <div class="col-sm-6">
