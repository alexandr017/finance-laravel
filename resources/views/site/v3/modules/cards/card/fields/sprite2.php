...
foreach ($iconList as $key => $value) {
		...
		if(strcasecmp($value, 'золотая корона') == 0)
		    $resIconList [] = '<span class="sprite i-korona def_bg" data-src="/sprite.svg" data-title="Золотую корону"></span>';
	...
	/***********/
		...
		if(strcasecmp($value, 'терминалы') == 0)
			    $resIconList [] = '<span class="sprite i-terminals def_bg" data-src="/sprite.svg" data-title="Терминал"></span>';
