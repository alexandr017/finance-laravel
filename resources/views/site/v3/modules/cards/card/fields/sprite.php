...
foreach ($iconList as $key => $value) {
		...
		if(strcasecmp($value, 'рапида') == 0)
			    $resIconList [] = '<span class="zaim-p-icon def_bg" style="background:url(/images/ic_pay/payment-8.png)" data-title="Рапиду"></span>';
		...
		if(strcasecmp($value, 'терминалы') == 0)
			    $resIconList [] = '<span class="zaim-p-icon def_bg" style="background:url(/images/ic_pay/payment-22.png)" data-title="Платежный терминал"></span>';
