@if(count($cards)>3)
	...
	@else
		<h2 class="fdsb listing-h2 text-center" id="comparison">Итоговое сравнение кредитов с онлайн-заявкой</h2>
	@endif
<table class="total_cards_table">
	<thead>
		<tr>
			<th class="display_none"></th>
			<th>@if(isset($tag_name)) @if($tag_name!='') Кредиты {{$tag_name}} @else Название @endif @else Название @endif</th>
