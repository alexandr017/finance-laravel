...
<div class="row">
    ...
    <hr>
    <div class="text-center"><button id="getReuslt" onclick="yaCounter38176370.reachGoal('calc-credit'); return true;">Найти кредиты</button></div>
...
<script src="/vzo_theme/js/jquery-ui.js"></script>
<script>
