...
<form action="/rko" class="rko_calc" method="POST">
    ...
    <div class="row">
        <div class="col-sm-6">
            <a href="#" id="rko_render" class="text-center">Подобрать <i class="fa fa-arrow-right"></i></a>
        </div>
...
<script>
    $('#show-hidded-block').click(function(){
        ...
        if($('#rko_clear_result').css('display') == 'none'){
            $('#rko_render').parent().removeClass('col-sm-6').addClass('col-sm-12');
        } else {
            $('#rko_render').parent().removeClass('col-sm-4').addClass('col-sm-6');
            $('#rko_clear_result').parent().removeClass('col-sm-4').addClass('col-sm-6');
        }
    ...
    $('#hide-hidded-block').click(function(){
        ...
        if($('#rko_clear_result').css('display') == 'none'){
            $('#rko_render').parent().removeClass('col-sm-12').addClass('col-sm-6');
            $(this).parent().removeClass('col-sm-4').addClass('col-sm-6');
        } else {
            $('#rko_render').parent().removeClass('col-sm-6').removeClass('col-sm-12').addClass('col-sm-4');
            $(this).parent().removeClass('col-sm-6').removeClass('col-sm-12').addClass('col-sm-4');
            $('#rko_clear_result').parent().removeClass('col-sm-6').removeClass('col-sm-12').addClass('col-sm-4');
        }
    ...
    $('#rko_render').click(function(e){
        ...
        if($('#show-hidded-block').css('display') == 'none'){
            ...
            $(this).parent().removeClass('col-sm-6').addClass('col-sm-4');
            $('#show-hidded-block').parent().removeClass('col-sm-6').addClass('col-sm-4');
        }
...
@section('additional-styles')
    ...
    <style>
        ...
        .calc-sub-title{    font-size: 30px;
            ...
            color: #fff;
            margin-bottom: 15px;}
        .rko_calc{padding: 15px;border: 2px solid #38b6f7; margin-bottom: 15px}
