        ...
        @if(isset($cards[0]))
            ...
            @if(isset($cards[0]))
                <div class="lvc">Срок: <div class="value"> от {{$cards[0]->term_min}} @if(isset($cards[0]->term_max) && $cards[0]->sum_max != null)
                            до {{$cards[0]->term_max}} лет @endif </div></div>
            @endif
            @if(isset($cards[0]))
                <div class="lvc">Процентная ставка: <div class="value">от {{$cards[0]->percent_min}} @if(isset($cards[0]->percent_max) && $cards[0]->sum_max != null)
                            до {{$cards[0]->percent_max}} % @endif </div></div>
            @endif
        @endif
