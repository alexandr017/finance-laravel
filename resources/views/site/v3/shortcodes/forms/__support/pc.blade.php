<form class="form" id="support">
    ...
    <div class="form-group">
        <label for="comment"><i class="red">*</i>Комментарий:</label>
        <textarea name="comment" class="form-control" id="comment" rows="8" required="true"></textarea>
    </div>
    <div class="form-group">
