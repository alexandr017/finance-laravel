<form class="form" id="widget_install">
    ...
    <div class="form-group">
        <label for="company"><i class="red">*</i> Название организации:</label>
        <input type="text" name="company" class="form-control" id="company" placeholder="Кредито 24" required="true">
    </div>
    <div class="form-group">
