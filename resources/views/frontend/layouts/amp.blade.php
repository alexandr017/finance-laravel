...
<head>
    ...
    <meta property="og:title" content="@yield('h1', app_name())" />
    <meta property="og:description" content="@yield('meta_description', app_name())" />
    <meta property="og:url" content="{{Request::url()}}" />
    <meta property="og:site_name" content="#ВсеЗаймыОнлайн" />
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:description" content="@yield('meta_description', app_name())" />
    <meta name="twitter:title" content="@yield('h1', app_name())" />
    ...
    <link rel="icon" type="image/png" href="/old_theme/img/logo_vzo.png" />
    ...
    <style amp-custom>
        <?php //echo file_get_contents(public_path().'/amp_theme/css/bootstrap-grid.css'); ?>
        <?php include public_path().'/amp_theme/css/s.php'; ?>
        <?php
...
<header>
    <div class="container">
                <div class="logo-head-wrap">
                    <a href="/"><amp-img width="46" height="42" layout="fixed" src="/old_theme/img/logo.png" alt=""></amp-img><span>#ВЗО</span></a>
                </div>
                <div class="header-label-rating">
                    <a href="/get-rating" rel="nofollow">Бесплатный кредитный рейтинг</a>
                </div>
