...
{{--?>--}}
    ...
    <meta name="google-site-verification" content="0Egjaac-Dgfdw71RFRcKMCeegvBW19Wgyb8Rm56YS-A" />
    <meta name="yandex-verification" content="77baad453c25fa56" />
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <link rel="preload" href="https://finance.ru/old_theme/fonts/ProximaNova/ProximaNova-Bold.woff" as="font" crossorigin="anonymous">
    <link rel="preload" href="https://finance.ru/old_theme/fonts/FuturaPT/FuturaPT-Medium.woff" as="font" crossorigin="anonymous">
    <link rel="preload" href="https://finance.ru/old_theme/fonts/ProximaNova/ProximaNova-Regular.woff" as="font" crossorigin="anonymous">
    <link rel="preload" href="https://finance.ru/old_theme/fonts/ProximaNova/ProximaNova-RegularIt.woff" as="font" crossorigin="anonymous">
    <link rel="preload" href="https://finance.ru/old_theme/fonts/FuturaPT/FuturaPT-Bold.woff" as="font" crossorigin="anonymous">
    <link rel="preload" href="https://finance.ru/old_theme/font-awesome-4.7.0/fonts/fontawesome-webfont.woff2?v=4.7.0" as="font" crossorigin="anonymous">
    <style><?php
...
<header class="second_header">
    @if(is_mobile_device())
        @include('frontend.includes.header-mob')
    @else
        @include('frontend.includes.header-pc')
    @endif
</header>
...
@if(Request::is('/'))
@include('frontend.includes.first-section')
@endif
...
<footer class="container">
    ...
    @endif
        ...
        @include('frontend.includes.menu.pc-footer-group-menu')
    @endif
    ...
    <div class="last-menu">
        <div class="row">
            <div class="col-md-12 d-md-block">
                @include('frontend.includes.menu.footer-last')
            </div>
        </div>
    </div>
...
@if(Auth::id() != 9287992879)
    <script src="/old_theme/js/jquery-3.2.1.min.js"></script>
    <?php /*
        <script src="/old_theme/js/index2.min.js" defer></script>
          */ ?>
        <?php $filename = public_path('old_theme/js/scripts.js'); ?>
        @if(file_exists($filename))
            <script src="https://finance.ru/old_theme/js/index2.php?a={{date ("dmYHis", filemtime($filename))}}" defer></script>
        @endif
@endif
