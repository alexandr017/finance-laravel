...
<article class="container main single-page">
    ...
    <div class="row">
        <div class="col-lg-9 col-md-12">
            @include('frontend.companies.company_menu')
            ...
            ?>
                ...
                @if(is_mobile_device())
                    @include("frontend.companies.$company_includes.".$group_name.'.face-mob')
                @else
                    @include("frontend.companies.$company_includes.".$group_name.'.face')
                @endif
            ...
            <div class="reviews-wrap comments-add-form">
                <div class="reviews-list-wrap">
                    @include('frontend.companies.reviews_includes.render')
                </div>
