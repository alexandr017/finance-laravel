...
<div class="companies-flex-item">
    <div class="showed-line">
        ...
        <div class="showed-wrapper showed-wrapper-5">
            <span>{!! number_format($card->header_1,0,'.',' ') !!}</span>
        </div>
    ...
    <div class="hidden-line @if($isFullWidth) block @endif">
        <div class="category_params_1">
            ...
            @endif
            @if($card->age_min != null || $card->age_min != null)
                <div class="line-prop">
            ...
            @endif
            @if($card->speed_see != null)
                <div class="line-prop">
                    <span class="line-prop-title fa-icon fa-bolt">Скорость рассмотрения заявки</span>
                    <span class="line-prop-value">{{$card->speed_see}}</span>
                </div>
            @endif
            @if($card->docs != null)
                <div class="line-prop">
