...
<div class="card-mn-tab-content">
    ...
    <div class="card-mn-tab-pane card-mn-docs">
        ...
        @endif
        @if(isset($card->security) && $card->security !== null)
            <div class="card-mn-row">
                <span class="card-mn-details">Обеспечение</span>
                <b class="card-mn-row-value">{{$card->security}}</b>
            </div>
        @endif
        @if(isset($card->an_initial_fee) && $card->an_initial_fee !== null)
            <div class="card-mn-row">
                <span class="card-mn-details">Первоначальный взнос</span>
                <b class="card-mn-row-value">{{$card->an_initial_fee}}</b>
            </div>
        @endif
