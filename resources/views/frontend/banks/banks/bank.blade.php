    ...
    <section class="container main single-page bank-page">
        <div class="row">
            ...
            @if(is_mobile_device())
                ...
                @include('frontend.banks.modules.bank_face.face-mob')
            @else
                @include('frontend.banks.modules.menu.pc')
                @include('frontend.banks.modules.bank_face.face')
            @endif
 ...
 */ ?>
                ...
                count($cardsRKO) > 0
                    ...
                    @include("frontend.banks.modules.special_offers.special_offers")
                @endif
                ...
                @if(count($news) > 0)
                    ...
                    <div class="popolar-posts-slider">
                        ...
                        <div class="text-center"><a class="form-btn1" href="{{Request::url()}}/news">Все новости банка</a></div>
                    </div>
                @endif
                ...
                @if(count($reviews) > 0)
                    <div id="fix-block">
                        ...
                        <div class="text-center"><a class="form-btn1" href="{{Request::url()}}/reviews">Все отзывы о банке</a></div>
                    </div>
                @endif
