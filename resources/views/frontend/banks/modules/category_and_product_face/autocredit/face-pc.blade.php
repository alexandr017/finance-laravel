        ...
        <div class="col-sm-9">
            ...
            <div class="row row-margin-block-1">
                ...
                <div class="col-sm-4">
                    ...
                    <div class="scb-value">от {{$cards[0]->term_min}} @if(isset($cards[0]->term_max)) @if($cards[0]->term_max != null && $cards[0]->term_max != 0) до {{$cards[0]->term_max}}  @endif месяцев @endif</div>
                </div>
                <div class="col-sm-4">
                    <span class="scb-label"><i class="fa fa-percent"></i> Процентная ставка</span>
                    <div class="scb-value">от {{$cards[0]->percent_min}} @if(isset($cards[0]->percent_max)) @if($cards[0]->percent_max != null && $cards[0]->percent_max != 0) до {{$cards[0]->percent_max}}  @endif % @endif</div>
                </div>
            </div>
            @endif
        </div>
            ...
            <tr>
                ...
                <td>
                    @if(isset($cards[0]->term_min))@if($cards[0]->term_min != null)
                        от {{$cards[0]->term_min}} @if(isset($cards[0]->term_max))@if($cards[0]->term_max != null && $cards[0]->term_max != 0) до {{$cards[0]->term_max}} месяцев@endif @endif
                    @endif @endif
                </td>
            </tr>
            <tr>
                ...
                <td>
                    @if(isset($cards[0]->percent_min))@if($cards[0]->percent_min != null)
                        от {{$cards[0]->percent_min}} @if(isset($cards[0]->percent_max)) @if($cards[0]->percent_max != null && $cards[0]->percent_max != 0)до {{$cards[0]->percent_max}} @endif @endif %
                    @endif @endif
                </td>
                <th>Возраст</th>
                <td>
                    @if(isset($cards[0]->age_min)) @if($cards[0]->age_min != null)
                        от {{$cards[0]->age_min}} @if(isset($cards[0]->age_max)) @if($cards[0]->age_max != null && $cards[0]->age_max) до {{$cards[0]->age_max}} @endif @endif лет
                    @endif @endif
                </td>
            </tr>
            <tr>
