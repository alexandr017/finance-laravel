...
liteChart.prototype.showTooltip = function(event, element, chart) {
	...
	if(x == chart.eventCoord.x && y == chart.eventCoord.y) {
		...
		chart.eventCoord.x = 0;
		chart.eventCoord.y = 0;
	}
	...
	switch (element.id) {
		case 'chart-line-point-0-0': x = 80; break;
		case 'chart-line-point-0-1': x = 140; break;
		case 'chart-line-point-0-2': x = 200; break;
		case 'chart-line-point-0-3': x = 260; break;
		case 'chart-line-point-0-4': x = 320; break;
		case 'chart-line-point-0-5': x = 380; break;
		case 'chart-line-point-0-6': x = 440; break;
		case 'chart-line-point-0-7': x = 500; break;
		case 'chart-line-point-0-8': x = 560; break;
		case 'chart-line-point-0-9': x = 620; break;
		case 'chart-line-point-0-10': x = 680; break;
		case 'chart-line-point-0-11': x = 740; break;
		case 'chart-line-point-0-112': x = 800; break;
	}
    y -= 10;
