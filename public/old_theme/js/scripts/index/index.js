$(document).ready(function() {
    ...
    $('#credit-select i').click(function () {
        $(this).parent().find('.hidden-elements').toggle();
    });
    $('#credit-select2 i').click(function () {
        $(this).parent().find('.hidden-elements').toggle();
    });
    ...
    $('#credit-select .hidden-elements .line').click(function () {
      ...
      $('#credit-select .hidden-elements').hide();
      ...
      if ($(this).parent().parent().is('#credit-select')) {
        ...
        $('#credit-select2 .hidden-elements .line').click(function () {
          ...
          $(this).parent().parent().find('.active-element').html(text);
          $(this).parent().find('.line').removeClass('active');
          $('#credit-select2 .hidden-elements').hide();
          $(this).addClass('active');
        });
    ...
    $('.go-to-page2').click(function(){
        location.href = $('.active-element2').attributes('data-val');
    });
