...
class CardsDebitsCards extends Model
{
    ...
    public static function go($request, $id,$action){
        ...
        $this2->percent_on_balance = (empty($request['percent_on_balance'])) ? null :  $request['percent_on_balance'];
    ...
    public static function parse_fields($code,$card){
        ...
        */
        ...
        $code = str_replace('{percent_on_balance}', $card->percent_on_balance, $code);
