...
class AMP
{
    ...
    {
        $html = str_replace('<i class="fa fa-star"></i>', '<amp-img alt="Рейтинг" width="15" height="15" layout="fixed" src="/old_theme/img/stars/star.png"></amp-img> ', $html);
        $html = str_replace('<i class="fa fa-star-half-o"></i>', '<amp-img alt="Рейтинг" width="15" height="15" layout="fixed" src="/old_theme/img/stars/star-half.png"></amp-img> ', $html);
        $html = str_replace('<i class="fa fa-star-o"></i>', '<amp-img alt="Рейтинг" width="15" height="15" layout="fixed" src="/old_theme/img/stars/star-empty.png"></amp-img> ', $html);
